...
microej {
    applicationEntryPoint = "com.microej.demo.sandbox.publisher.MqttPublisherEntryPoint"
}
...
dependencies {
    ...
    implementation("ej.library.iot:connectivity:3.0.0")
    implementation("ej.library.iot:net-util:1.4.0")

    implementation(project(":sharedinterface"))

    // Run all the applications together
    microejApplication(project(":app-power-provider"))
